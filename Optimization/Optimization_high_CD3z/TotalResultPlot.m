...
for idx=1:5
    ...
    scatter( repmat(-1+(idx-3)/10,1,11), paramfit(:,idx,1), 150, 'MarkerFaceColor', color(idx), ...
...
for idx=1:5
    ...
    scatter( repmat(0+(idx-3)/10,1,11), paramfit(:,idx,2), 150, 'MarkerFaceColor', color(idx), ...
                                          'MarkerFaceAlpha', .2,'MarkerEdgeColor','none')
    hold on
...
for idx=1:5
    ...
    scatter( repmat(1+(idx-3)/10,1,11), paramfit(:,idx,4), 150, 'MarkerFaceColor', color(idx),  ...
                                           'MarkerFaceAlpha', .2,'MarkerEdgeColor','none')
    hold on
