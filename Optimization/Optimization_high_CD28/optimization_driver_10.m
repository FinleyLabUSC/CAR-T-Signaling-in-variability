 userpath='/project/sfinley_292/vtseruny/Optimization_high_CD28_10'
 MPCTprofile=parallel.cluster.Local;
 MPCTprofile.NumWorkers=21;
 MPCTprofile.JobStorageLocation='/project/sfinley_292/vtseruny/Optimization_high_CD28_10';
...
for i=1:11
    ...
    ObjFuncName = 'objective_function_10';
    [gp_best,gf_best] = mnb_PSOFit(ObjFuncName,LB,UB,PSOopts);
    display(gp_best)
    gp_aggregator(i,:)=gp_best;
    gf_aggregator(i)=gf_best;

    % save('PSOresults_10.mat','gp_aggregator','gf_aggregator')

end

display(gp_aggregator)
display(gf_aggregator)
