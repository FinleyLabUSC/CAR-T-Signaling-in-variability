...
xlabel("Activation time, min", 'FontWeight', 'Bold','fontsize',20)
set(gca,'XTickLabel', get(gca,'XTickLabel'),'fontsize',20,'FontWeight','bold')
set(gca,'YTickLabel', get(gca,'YTickLabel'),'fontsize',20,'FontWeight','bold')
...
ylabel("Number of Cells", 'FontWeight', 'Bold','fontsize',20)
set(gca,'YTickLabel', get(gca,'YTickLabel'),'fontsize',20,'FontWeight','bold')
xtickangle(90)
